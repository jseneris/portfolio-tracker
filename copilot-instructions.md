Sample Instructions for GitHub Copilot
This sample instructions file is designed for a React Single Page Application (SPA) frontend with a Microsoft SQL Server (MS-SQL) backend. It provides guidance on coding standards, architectural preferences, and specific technologies used in the project.
